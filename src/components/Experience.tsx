    ...
    <section id="experience" className="section-padding">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <div className="w-24 h-1 bg-gradient-to-r from-primary to-blue-400 mx-auto mb-8"></div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {achievements.map((achievement, index) => (
            <a
              ...
              className="glass-effect p-6 rounded-xl hover:scale-105 transition-all duration-300 group cursor-pointer animate-scale-in"
              style={{ animationDelay: `${index * 0.1}s` }}
            >
              <div className="flex items-start gap-4">
